...
<html lang="en" class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>ساجم - سامانه جامع مسکن</title>
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <meta content="width=device-width, initial-scale=1" name="viewport"/>
        <meta content="سامانه جامع معاملات مسکن در سراسر ایران." name="description"/>
        <meta content="گروه توسعه الف" name="author"/>
                        ...
                        <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".nav-collapse">
                          ...
                          <div class="logo">
                            <a class="logo-wrap" href="#body">
                                <img class="logo-img logo-img-main" src="img/logo-sajem.png" alt="Sajem Logo">
                                <img class="logo-img logo-img-active" src="img/logo-sajem2.png" alt="Sajem Dark Logo">
                            </a>
                        </div>
                    </div>
